import{aV as H,aS as g,bc as W,aH as K,aT as c,b3 as _,b9 as V,bm as G,aP as E,aQ as U,aR as Y,aG as N,az as m,bn as j,aZ as k,a_ as C,a$ as h,aY as L,bo as X,bp as v,aB as z,aA as O,aC as q,aX as Q}from"./index-BrDoqvqQ.js";import{r as d,c as w,n as l,o as Z}from"./index-Ptgpv_ju.js";import"./index-B3LX01Kp.js";import{e as J,n as ee}from"./ref-soEToFJy.js";import"./index-C1gZqc8b.js";import{H as I}from"./HelpersUtil-Bds7Hj1B.js";import"./index-DJbp7tUr.js";import"./index-DJEg05tP.js";import"./index-CBbVMXaD.js";import"./index-BSJwKDa9.js";import"./index-CLv4lDPz.js";import{N as te}from"./NavigationUtil-DmfK5sOV.js";import"./ConstantsUtil-COJBkkkj.js";const ie=H`
  div {
    width: 100%;
  }
...
`;var y=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(o=(n<3?a(o):n>3?a(t,i,o):a(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};const ne={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},ae={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let u=class extends g{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return c`
    ...
    `}isV6(){return(j.get("dapp_smart_account_version")||"v6")==="v6"}toggleSmartAccountVersion(){j.set("dapp_smart_account_version",this.isV6()?"v7":"v6"),typeof window<"u"&&window?.location?.reload()}togglePreferredAccountTypeTemplate(){const t=this.network?.chainNamespace,i=m.checkIfSmartAccountEnabled(),r=_.getConnectorId(t);return!_.getAuthConnector()||r!==k.CONNECTOR_ID.AUTH||!i?null:(this.switched||(this.text=C(t)===h.ACCOUNT_TYPES.SMART_ACCOUNT?"Switch to your EOA":"Switch to your Smart Account"),c`
      <wui-list-item
        icon="swapHorizontal"
        ?rounded=${!0}
        ?chevron=${!0}
    ...
    `)}async changePreferredAccountType(){const t=this.network?.chainNamespace,i=m.checkIfSmartAccountEnabled(),r=C(t)===h.ACCOUNT_TYPES.SMART_ACCOUNT||!i?h.ACCOUNT_TYPES.EOA:h.ACCOUNT_TYPES.SMART_ACCOUNT;_.getAuthConnector()&&(this.loading=!0,await L.setPreferredAccountType(r,t),this.text=r===h.ACCOUNT_TYPES.SMART_ACCOUNT?"Switch to your EOA":"Switch to your Smart Account",this.switched=!0,X.resetSend(),this.loading=!1,this.requestUpdate())}};A([d()],$.prototype,"loading",void 0);A([d()],$.prototype,"switched",void 0);A([d()],$.prototype,"text",void 0);A([d()],$.prototype,"network",void 0);$=A([w("w3m-smart-account-settings-view")],$);const ce=E`
  :host {
    width: 100%;
  }
