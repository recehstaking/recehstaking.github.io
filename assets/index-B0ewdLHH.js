import{aW as w,aM as v,aN as y,aO as x,aV as $,aS as g,aX as R,bc as T,aT as m,aP as C}from"./index-BrDoqvqQ.js";import{n as P,r as h,c as b}from"./index-Ptgpv_ju.js";const s=x({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),_={state:s,subscribe(t){return y(s,()=>t(s))},subscribeKey(t,e){return v(s,t,e)},showTooltip({message:t,triggerRect:e,variant:o}){s.open=!0,s.message=t,s.triggerRect=e,s.variant=o},hide(){s.open=!1,s.message="",s.triggerRect={width:0,height:0,top:0,left:0}}},n=w(_),O=$`
  :host {
    width: 100%;
    display: block;
  }
