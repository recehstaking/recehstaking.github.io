import{bc as x,bx as te,aX as c,aY as ne,aP as g,aQ as j,aS as b,aT as d,b1 as _,aR as se,az as f,aU as D,b8 as L,br as le,aA as U,aH as R,b3 as F,aV as ce,aC as A,bh as T,b9 as de,by as ue,bz as pe}from"./index-BrDoqvqQ.js";import{c as m,n as l,o as k,r as u,U as ie}from"./index-Ptgpv_ju.js";import{P as z}from"./index-BUWzcstw.js";import"./index-B3LX01Kp.js";import{H as q}from"./HelpersUtil-Bds7Hj1B.js";import{C as V}from"./ConstantsUtil-COJBkkkj.js";import"./index-C1gZqc8b.js";import"./index-BSJwKDa9.js";import"./index-B0ewdLHH.js";import"./index-iHuOdxky.js";import{S as he}from"./SwapController-Bui1Ha8d.js";import"./index-CBbVMXaD.js";import"./index-DJEg05tP.js";import"./index-CLt8Ait4.js";import"./index-B1HW3tEy.js";import"./index-w_T2CtJH.js";import"./index-7mx_iRco.js";import"./MathUtil-BGCe3rZ3.js";import"./index-BO-Kja9X.js";import"./index-CLv4lDPz.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
...
`;var X=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};const be={info:"info",success:"checkmark",warning:"warningCircle",error:"warning"};let P=class extends b{constructor(){super(...arguments),this.message="",this.type="info"}render(){return d`
    ...
    `}onClose(){_.close()}};P.styles=[j,we];X([l()],P.prototype,"message",void 0);X([l()],P.prototype,"type",void 0);P=X([m("wui-alertbar")],P);const ge=g`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
