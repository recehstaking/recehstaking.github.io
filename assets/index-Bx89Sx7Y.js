import{aP as v,aQ as I,aR as R,aS as f,aT as l,aH as m,az as d,br as ke,b8 as k,aB as g,bc as N,aV as Z,aA as $,bb as me,b3 as b,aZ as C,aX as h,aG as O,aC as E,aY as y,a_ as ze,a$ as Fe,bP as Gt,bQ as he,bE as Q,bC as qi,bh as A,bR as tt,b1 as Ai,bj as Ki,bi as Gi,bg as Xi,b9 as ft,bt as Xt,bu as Yt,bS as Yi,bT as Qi,bx as jt,bU as Ji}from"./index-BrDoqvqQ.js";import{n as c,c as p,o as w,U,r as u,b as Ii}from"./index-Ptgpv_ju.js";import"./index-B3LX01Kp.js";import"./index-C1gZqc8b.js";import"./index-BuUoD4Uv.js";import"./index-BSJwKDa9.js";import{W as xr,a as $r}from"./index-iHuOdxky.js";import"./index-DJEg05tP.js";import"./index-CLt8Ait4.js";import"./index-CBbVMXaD.js";import{H as Qt}from"./HelpersUtil-Bds7Hj1B.js";import{n as Zi}from"./index-B1HW3tEy.js";import{E as Y}from"./ExchangeController-CbzLVjCk.js";import"./index-CltYK7k0.js";import"./index-GVYHxYMR.js";import"./index-B0ewdLHH.js";import{M as mt}from"./MathUtil-BGCe3rZ3.js";import"./index-w_T2CtJH.js";import{e as Jt,n as Zt}from"./ref-soEToFJy.js";import"./index-DJbp7tUr.js";import"./index-7mx_iRco.js";import"./index-BO-Kja9X.js";import"./index-Dree1fy5.js";import{O as bt}from"./index-B5fE1BXr.js";import{e as en}from"./index-Du5DNSez.js";import"./index-CLv4lDPz.js";import"./index-C-hsWwtE.js";import{N as tn}from"./NavigationUtil-DmfK5sOV.js";import"./index-BiMNDIFH.js";import"./ConstantsUtil-COJBkkkj.js";const nn=v`
  :host {
    display: block;
  }
...
`;var xo=function(t,e,i,o){var a=arguments.length,n=a<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(n=(a<3?r(n):a>3?r(e,i,n):r(e,i))||n);return a>3&&n&&Object.defineProperty(e,i,n),n};let Kt=class extends f{constructor(){super(...arguments),this.dappImageUrl=m.state.metadata?.icons,this.walletImageUrl=d.getAccountData()?.connectedWalletInfo?.icon}firstUpdated(){const e=this.shadowRoot?.querySelectorAll("wui-visual-thumbnail");e?.[0]&&this.createAnimation(e[0],"translate(18px)"),e?.[1]&&this.createAnimation(e[1],"translate(-18px)")}render(){return l`
    ...
    `}async onSign(){this.isSigning=!0;try{await jt.requestSignMessage()}catch(e){if(e instanceof Error&&e.message.includes("OTP is required")){E.showError({message:"Something went wrong. We need to verify your account again."}),h.replace("DataCapture");return}throw e}finally{this.isSigning=!1}}async onCancel(){this.isCancelling=!0,await jt.cancelSignMessage().finally(()=>this.isCancelling=!1)}};si([u()],Tt.prototype,"isCancelling",void 0);si([u()],Tt.prototype,"isSigning",void 0);Tt=si([p("w3m-siwx-sign-message-view")],Tt);export{ci as AppKitAccountButton,ui as AppKitButton,pi as AppKitConnectButton,fi as AppKitNetworkButton,li as W3mAccountButton,be as W3mAccountSettingsView,zt as W3mAccountView,xt as W3mAllWalletsView,di as W3mButton,At as W3mChooseAccountNameView,hi as W3mConnectButton,M as W3mConnectView,It as W3mConnectWalletsView,yi as W3mConnectingExternalView,Ct as W3mConnectingMultiChainView,Et as W3mConnectingWcBasicView,we as W3mConnectingWcView,Ci as W3mDownloadsView,xr as W3mFooter,Re as W3mFundWalletView,Si as W3mGetWalletView,wi as W3mNetworkButton,ot as W3mNetworkSwitchView,Le as W3mNetworksView,L as W3mProfileWalletsView,$r as W3mRouter,Tt as W3mSIWXSignMessageView,_t as W3mSwitchActiveChainView,at as W3mUnsupportedChainView,qt as W3mWalletCompatibleNetworksView,Ei as W3mWhatIsANetworkView,ki as W3mWhatIsAWalletView};
